...
const App = ({ currentStepId }) => {

  const steps = [
    { id: 'Step 1', name: 'Type', description: '', href: '#' },
    { id: 'Step 2', name: 'Address', description: '', href: '#' },
    { id: 'Step 3', name: 'Units', description: '', href: '#' },
    { id: 'Step 4', name: 'Bank Accounts', description: '', href: '#' },
    { id: 'Step 5', name: 'Reserve funds', description: '', href: '#' },
    { id: 'Step 6', name: 'Ownership', description: '', href: '#' }
  ];

  const stepsWithStatus = steps.map((step) => {
    if (parseInt(step.id.slice(-1), 10) < currentStepId) {
      return { ...step, status: 'complete' };
    } else if (parseInt(step.id.slice(-1), 10) === currentStepId) {
